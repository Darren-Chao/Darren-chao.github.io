...
const projectsData = [
  {
    ...
    content: [
      { type: "image", src: "assets/project-images/jukebox/1.png", size: "large" },
      { type: "images-row", images: [ "assets/project-images/jukebox/2.png", "assets/project-images/jukebox/3.png", "assets/project-images/jukebox/4.png" ] },
      { type: "text", heading: "Overview", text: "Jukebox 2.0 is an interactive record player that translates hand drawn color doodles into melodies, enabling people with no musical training to compose music through simple, physical interaction. By mapping color to sound, the system reframes music making from a technical skill into an intuitive, playful experience and invites users to explore composition through drawing rather than notation." },
      { type: "text", text: "This project was developed as a collaboration between Ellie Na and Yang Tian." },
      { type: "text", text: "The project addresses a core accessibility gap in music. Many people remain passive listeners because traditional instruments and software require prior knowledge. Jukebox 2.0 lowers this barrier by allowing anyone, including children, beginners, or individuals with cognitive decline, to engage in expressive creation using only markers and paper." },
      { type: "text", text: "Built as a two week sprint, the piece was exhibited as part of a \u201cConnections\u201d exhibition highlighting new ways technology can bridge people and creative expression." },
      { type: "image", src: "assets/project-images/jukebox/5.png", size: "small" },
      { type: "text", text: "Users draw linear color patterns on paper and feed them through the device. A color sensor reads the hues and converts them into musical tones in real time. Playback alternates between speakers, producing a dynamic melody that reflects the visual composition." },
      { type: "list", heading: "System flow:", items: [ "Input: Physical color drawings read via RGB color sensor", { text: "Processing:", subItems: [ "Convert RGB to hue", "Categorize hue into tonal groups", "Map to corresponding notes" ] }, "Output: Layered tones played through speakers as the strip moves" ] },
      { type: "text", heading: "Process", text: "The project progressed through rapid prototyping and continuous refinement. We began with breadboard prototypes to validate sensing and sound mapping, then iterated through four enclosure designs to improve proportions, usability, and internal layout. The color to sound algorithm was revised multiple times to achieve stronger musical coherence. As the system matured, we transitioned to a custom hand soldered PCB for reliability, refined the acoustic output through testing different tonal palettes and playback behaviors, and completed final fabrication that integrated electronics, mechanism, and enclosure into a cohesive object." },
      { type: "text", text: "The final artifact demonstrates how physical interaction and computational translation can open creative practices to broader audiences. By connecting color, motion, and sound, Jukebox 2.0 creates an approachable pathway into music making and transforms drawing into composition." },
      { type: "image", src: "assets/project-images/jukebox/6.png", size: "medium" },
  ...
  
  {
    ...
    content: [
      ...
      { type: "images-row", images: [ "assets/project-images/steadystix/2.png", "assets/project-images/steadystix/3.png", "assets/project-images/steadystix/4.png" ] },
      ...
      { type: "images-row", images: [ "assets/project-images/steadystix/5.png", "assets/project-images/steadystix/6.png", "assets/project-images/steadystix/7.png" ] },
  ...
  
  {
    ...
    content: [
      { type: "image", src: "assets/project-images/sand-siege/1.png", size: "large" },
      ...
      { type: "images-row", images: [ "assets/project-images/sand-siege/2.png", "assets/project-images/sand-siege/3.png", "assets/project-images/sand-siege/4.png", "assets/project-images/sand-siege/5.png" ] },
      ...
      { type: "images-row", images: [ "assets/project-images/sand-siege/6.png", "assets/project-images/sand-siege/7.png", "assets/project-images/sand-siege/8.png" ] },
  ...
  
  {
    ...
    content: [
      { type: "image", src: "assets/project-images/dripless/1.png", size: "large" },
      ...
      { type: "images-row", images: [ "assets/project-images/dripless/2.png", "assets/project-images/dripless/3.png", "assets/project-images/dripless/4.png" ] },
      { type: "text", text: "Through filtering, we ruled out personal attachments due to umbrella variability, at home solutions because they address the problem too late, and wall mounted concepts that created awkward interactions. This process led us toward a shared, ground based public device." },
      ...
      { type: "images-row", images: [ "assets/project-images/dripless/5.png", "assets/project-images/dripless/6.png", "assets/project-images/dripless/7.png" ] },
      ...
      { type: "images-row", images: [ "assets/project-images/dripless/8.png", "assets/project-images/dripless/9.png" ] },
      ...
      { type: "text", text: "User tests with simple mockups revealed that people prefer a quick drop in motion without bending or carefully positioning the umbrella, especially when carrying bags." },
  ...
  
  {
    ...
    content: [
      { type: "image", src: "assets/project-images/costumes/1.png", size: "large" },
      ...
      { type: "images-row", images: [ "assets/project-images/costumes/2.png", "assets/project-images/costumes/3.png" ] },
      ...
      { type: "images-row", images: [ "assets/project-images/costumes/4.png", "assets/project-images/costumes/5.png" ] },
      { type: "images-row", images: [ "assets/project-images/costumes/6.png", "assets/project-images/costumes/7.png" ] },
      { type: "text", heading: "Project Evolution and Takeaways" },
      { type: "text", heading: "Costume 1 \u2014 Material and Finish Exploration", text: "The first build explored a range of materials including foam, cardboard, and fabric, alongside spray painting and hand painting techniques. The goal was to understand how different materials behave structurally and visually." },
      { type: "image", src: "assets/project-images/costumes/8.png", size: "small" },
      { type: "text", heading: "Costume 2 \u2014 Pattern Complexity and Surface Effects", text: "This costume pushed template creation further and introduced advanced finishing methods such as using iron powder to create convincing rust textures. Assembly techniques improved through transitioning from hot glue to contact cement for stronger bonds." },
      { type: "text", text: "Video: https://youtube.com/shorts/FTA3at0dS10" },
      { type: "image", src: "assets/project-images/costumes/9.png", size: "medium" },
      { type: "text", heading: "Costume 3 \u2014 Mobility and Textile Integration", text: "Focus shifted toward improving wearability and comfort, incorporating fabrics and learning sewing fundamentals. Pattern making became more sophisticated to accommodate movement while maintaining visual fidelity." },
      { type: "text", text: "Video: https://youtu.be/VdazJukZR2Q" },
      { type: "image", src: "assets/project-images/costumes/10.png", size: "medium" },
      { type: "text", heading: "Costume 4 \u2014 Detail Fidelity and Electronics Integration", text: "This build emphasized accuracy to an existing character design, requiring careful attention to detail. Basic circuitry was integrated to power blinking LED eyes, introducing electronics into the fabrication workflow." },
      { type: "text", text: "Video: https://youtube.com/shorts/ntudqSLgeD4" },
      { type: "image", src: "assets/project-images/costumes/11.png", size: "medium" },
  ...
  
  {
    ...
    content: [
      { type: "image", src: "assets/project-images/freelens/1.png", size: "large" },
      { type: "text", heading: "Overview", text: "FreeLens is a concept extension to Expensify designed to help freelancers track expenses at the project level, reduce administrative burden, and avoid missed tax deductions. Our team designed a streamlined experience that allows users to capture receipts, automatically organize spending, and separate personal and business finances. The project culminated in an investment style pitch demonstrating product strategy, market opportunity, and user value." },
      { type: "text", text: "This project was developed as a collaboration between Ellie Na, Crystal Wang, Shelly Liu, Veronica Cargay, and Darren Chao." },
      ...
      { type: "image", src: "assets/project-images/freelens/2.png", size: "large" },
      ...
      { type: "image", src: "assets/project-images/freelens/3.png", size: "large" },
      ...
      { type: "image", src: "assets/project-images/freelens/4.png", size: "large" },
  ...
  
  {
    ...
    content: [
      { type: "image", src: "assets/project-images/folded-reality/1.png", size: "large" },
      ...
      { type: "images-row", images: [ "assets/project-images/folded-reality/2.png", "assets/project-images/folded-reality/3.png" ] },
      ...
      { type: "images-row", images: [ "assets/project-images/folded-reality/4.png", "assets/project-images/folded-reality/5.png" ] },
      ...
      { type: "images-row", images: [ "assets/project-images/folded-reality/6.png", "assets/project-images/folded-reality/7.png", "assets/project-images/folded-reality/8.png" ] },
      ...
      { type: "images-row", images: [ "assets/project-images/folded-reality/9.png", "assets/project-images/folded-reality/10.png", "assets/project-images/folded-reality/11.png" ] },
